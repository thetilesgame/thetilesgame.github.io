...
(function() {
	...
	// Initialize "On Visible" animations.
		...
		onvisible.add('.image.style4', { style: 'fade-up', speed: 1000, intensity: 0, threshold: 1, delay: 0, replay: false });
		onvisible.add('.image.style3', { style: 'fade-up', speed: 1000, intensity: 0, threshold: 1, delay: 0, replay: false });
		onvisible.add('.image.style2', { style: 'fade-up', speed: 1000, intensity: 2, threshold: 1, delay: 250, replay: false });
		onvisible.add('hr.style1', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 1, delay: 0, replay: false });
